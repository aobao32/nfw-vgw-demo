...
- 1) 从云上到 IDC方向：修改 `prv-rt-az1` 和 `prv-rt-az2`，显式增加路由条目，将去往 IDC 的流量发送到 NFW 的 Endpoint
- 2) 从IDC到云上方向：修改 `vgw-ingress-rt` 路由表，显式增加路由条目，将去往 云上VPC 的流量发送到 NFW 的 Endpoint
